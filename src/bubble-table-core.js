(function (root, factory) {
  ...
  function buildStyleText(id, style) {
    ...
    return [
      ...
      rootClass + " .bst-toolbar { display:flex; flex:0 0 auto; gap:" + toolbarGap + "; align-items:center; padding:6px; background:" + style.toolbarBackground + "; border:1px solid " + style.border + "; border-bottom:0; box-sizing:border-box; }",
      ...
      rootClass + " .bst-fallback-table th { background:" + style.headerBackground + "; color:" + style.headerText + "; border:1px solid " + style.border + "; height:" + Number(style.rowHeight) + "px; padding:" + cellPaddingY + " " + cellPaddingX + "; text-align:left; font-weight:" + style.headerFontWeight + "; }",
      rootClass + " .bst-fallback-table td { background:" + style.rowBackground + "; color:" + style.text + "; border:1px solid " + style.border + "; height:" + Number(style.rowHeight) + "px; padding:" + cellPaddingY + " " + cellPaddingX + "; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }",
      ...
      rootClass + " .tabulator { border-color:" + style.border + "; color:" + style.text + "; font-size:" + Number(style.fontSize) + "px; font-family:" + style.fontFamily + "; }",
      rootClass + " .tabulator .tabulator-header { background:" + style.headerBackground + "; border-color:" + style.border + "; color:" + style.headerText + "; font-weight:" + style.headerFontWeight + "; }",
      rootClass + " .tabulator .tabulator-header .tabulator-col { background:" + style.headerBackground + "; border-color:" + style.border + "; color:" + style.headerText + "; font-weight:" + style.headerFontWeight + "; }",
      ...
      rootClass + " .tabulator-row .tabulator-cell { border-color:" + style.border + "; padding:" + cellPaddingY + " " + cellPaddingX + "; }",
